...
import zone.blob.config.Constants;
import zone.blob.domain.Authority;
import zone.blob.domain.User;
import zone.blob.repository.AuthorityRepository;
import zone.blob.repository.UserRepository;
import zone.blob.security.AuthoritiesConstants;
import zone.blob.service.MailService;
import zone.blob.service.UserService;
import zone.blob.service.dto.PasswordChangeDTO;
import zone.blob.service.dto.UserDTO;
import zone.blob.web.rest.errors.ExceptionTranslator;
import zone.blob.web.rest.vm.KeyAndPasswordVM;
import zone.blob.web.rest.vm.ManagedUserVM;
