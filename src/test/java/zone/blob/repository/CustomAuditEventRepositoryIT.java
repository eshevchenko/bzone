...
import zone.blob.config.audit.AuditEventConverter;
import zone.blob.domain.PersistentAuditEvent;
...
import static zone.blob.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
