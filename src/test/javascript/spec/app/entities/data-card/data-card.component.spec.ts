...
import { DataCardComponent } from 'app/entities/data-card/data-card.component';
...
describe('Component Tests', () => {
  describe('DataCard Management Component', () => {
    let comp: DataCardComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DataCardComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.dataCards[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
