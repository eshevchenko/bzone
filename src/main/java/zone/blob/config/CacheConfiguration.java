...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, zone.blob.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, zone.blob.repository.UserRepository.USERS_BY_EMAIL_CACHE);
